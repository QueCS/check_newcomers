...
def get_player_ids_from_highscore_api(xml_tree):
    """
    ...
    for child in xml_tree:
        try:
            ...
            logging.warning('Calling get_player_ids_from_highscore_api(): Attribute "id" not found in XML tree.')
            return None
    return ids
...
def get_player_name_from_player_api(xml_tree):
    """
    ...
    try:
        ...
        logging.warning('Calling get_player_name_from_player_api(): Attribute "name" not found in XML tree.')
        return None
